...
# Name the game
window.title("Value Matching")

# Do not resize
#window.resizable(False, False)

### value frame ###
top_frame = ttk.LabelFrame(window)
top_frame.grid(column = 0, row = 0)
###########

###########
# create default (crosby) photo
get_crosby = Image.open("crosby.jpg")
get_crosby_simple = SimpleImage("crosby.jpg")
base_image = ImageTk.PhotoImage(get_crosby)
###########

### middle frame ###
middle_frame = ttk.LabelFrame(window)
middle_frame.grid(column = 0, row = 2)
###########

### bottom frame ###
bottom_frame = ttk.LabelFrame(window)
...
# Add label
user_pic_choice_label = ttk.Label(bottom_frame, text="xx")
user_pic_choice_label.grid(column = 0, row = 0)

instruction_label_1 = ttk.Label(bottom_frame, text="Click on reference photo to choose a value")
instruction_label_1.grid(column = 0, row = 0)

instruction_label_2 = ttk.Label(bottom_frame, text="Click on value bar to choose a value")
instruction_label_2.grid(column = 0, row = 2)


# def click_pic():
#     action.configure(text="I have been clicked!")
#     user_pic_choice_label.configure(foreground = 'red')
#     user_pic_choice_label.configure(text = "You chose:")
#
# action = ttk.Button(buttons_frame, text = "click me!", command = click_pic)
# action.grid(column = 1, row = 0)

# user_value_choice_label = ttk.Label(buttons_frame, text="Click on value bar to choose a value")
# # user_value_choice_label.grid(column = 0, row = 0)
#
# def click_value():
#     other_action.configure(text="I have been clicked!")
#     user_value_choice_label.configure(foreground = 'blue')
#     user_value_choice_label.configure(text = " You chose:")
#
# other_action = ttk.Button(buttons_frame, text = "click me!", command = click_value)
# other_action.grid(column = 1, row = 1)


# draw window
window.mainloop()

    # default_image = pyglet.resource.image("crosby.png")
    # white_gif = pyglet.resource.image("white.gif")
    # seventeen_gif = pyglet.resource.image("seventeen.gif")
    # thirtyfour_gif = pyglet.resource.image("thirtyfour.gif")
    # fifty_gif = pyglet.resource.image("fifty.gif")
    # sixtyseven_gif = pyglet.resource.image("sixtyseven.gif")
    # eightyfour_gif = pyglet.resource.image("eightyfour_gif")
    # black_gif = pyglet.resource.image("black")
    ...
    #
    # # put white button
    # white_gif = PhotoImage(file = "white.gif")
    ...
    #
    # # put 17% button
    # seventeen_gif = PhotoImage(file = "seventeen.gif")
    ...
    #
    # # put 34% button
    # thirtyfour_gif = PhotoImage(file = "thirtyfour.gif")
    ...
    #
    # # put 50% button
    # fifty_gif = PhotoImage(file = "fifty.gif")
    ...
    #
    # # put 67% button
    # sixtyseven_gif = PhotoImage(file = "sixtyseven.gif")
    ...
    #
    # # put 84% button
    # eightyfour_gif = PhotoImage(file = "eightyfour.gif")
    ...
    #
    # # put black button
    # black_gif = PhotoImage(file = "black.gif")
